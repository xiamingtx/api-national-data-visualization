...
@pytest.mark.resource
def test_delete_countryResource():
...
@pytest.mark.resource
def test_get_query_countryResource():
...
@pytest.mark.resource
def test_joint_query_countryResource():
